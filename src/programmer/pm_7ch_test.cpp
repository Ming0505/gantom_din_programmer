...
static int ch7_test_step = 0;
Button_state button_check(FactoryTest* ft);
class PM_ch7_test : public SmoothSelector
{
    ...
    void onRender() override
    {
        ...
        if(ch7_test_step == 0){
            ...
            _ft->_canvas->drawString("CH1: 255",60, 30); //brightness
            _ft->_canvas->drawString("CH2: 255",180, 30);
        ...
        }else if(ch7_test_step == 1){
            _ft->_canvas->drawCentreString("STEP 2",120, 0);
            _ft->_canvas->drawString("CH1: 255",60, 30); //brightness
            _ft->_canvas->drawString("CH2:   0",180, 30);
            _ft->_canvas->drawString("CH3: 255",60, 50);
            _ft->_canvas->drawString("CH4:   0",180, 50);
            _ft->_canvas->drawString("CH5:   0",60, 70);
            _ft->_canvas->drawString("CH6:   0",180, 70);
            _ft->_canvas->drawString("CH7:   0",60, 90);
            _ft->_canvas->drawString("CH8:   0",180, 90);
        }else if(ch7_test_step == 2){
            _ft->_canvas->drawCentreString("STEP 3",120, 0);
            _ft->_canvas->drawString("CH1: 255",60, 30); //brightness
            _ft->_canvas->drawString("CH2:   0",180, 30);
            _ft->_canvas->drawString("CH3:   0",60, 50);
            _ft->_canvas->drawString("CH4: 255",180, 50);
            _ft->_canvas->drawString("CH5:   0",60, 70);
            _ft->_canvas->drawString("CH6:   0",180, 70);
            _ft->_canvas->drawString("CH7:   0",60, 90);
            _ft->_canvas->drawString("CH8:   0",180, 90);
        }else if(ch7_test_step == 3){
            _ft->_canvas->drawCentreString("STEP 4",120, 0);
            _ft->_canvas->drawString("CH1: 255",60, 30); //brightness
            _ft->_canvas->drawString("CH2:   0",180, 30);
            _ft->_canvas->drawString("CH3:   0",60, 50);
            _ft->_canvas->drawString("CH4:   0",180, 50);
            _ft->_canvas->drawString("CH5: 255",60, 70);
            _ft->_canvas->drawString("CH6:   0",180, 70);
            _ft->_canvas->drawString("CH7:   0",60, 90);
            _ft->_canvas->drawString("CH8:   0",180, 90);
        }else if(ch7_test_step == 4){
            ...
            _ft->_canvas->drawString("CH7:   0",60, 90);
            _ft->_canvas->drawString("CH8:   0",180, 90);
        }else if(ch7_test_step == 5){
            _ft->_canvas->drawCentreString("STEP 6",120, 0);
            _ft->_canvas->drawString("CH1: 255",60, 30); //brightness
            _ft->_canvas->drawString("CH2:   0",180, 30);
            _ft->_canvas->drawString("CH3:   0",60, 50);
            _ft->_canvas->drawString("CH4:   0",180, 50);
            ...
            _ft->_canvas->drawString("CH8:   0",180, 90);
        }else if(ch7_test_step == 6){
            _ft->_canvas->drawCentreString("STEP 7",120, 0);
            _ft->_canvas->drawString("CH1: 255",60, 30); //brightness
            _ft->_canvas->drawString("CH2:   0",180, 30);
            _ft->_canvas->drawString("CH3:   0",60, 50);
            _ft->_canvas->drawString("CH4:   0",180, 50);
        ...
        }else if(ch7_test_step == 7){
            _ft->_canvas->drawCentreString("STEP 8",120, 0);
            _ft->_canvas->drawString("CH1: 255",60, 30); //brightness
            _ft->_canvas->drawString("CH2: 255",180, 30);
            _ft->_canvas->drawString("CH3: 255",60, 50);
            _ft->_canvas->drawString("CH4: 255",180, 50);
...
static PM_ch7_test* _launcher_menu = nullptr;

extern uint32_t time_settings;
void pm_7ch_test_task(FactoryTest* ft)
{
    // Create menu
    _launcher_menu = new PM_ch7_test();
